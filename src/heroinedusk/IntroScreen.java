...
public class IntroScreen extends BaseScreen { // Extends the BaseScreen class.
    ...
    loadAssets:  Loads the assets based on the current size of the application window.
    ...
    */
    ...
    // Declare constants.
    private final float audioVolume = 0.80f; // Volume to use with Music objects.
    ...
    public final void create()
    {
        ...
        4.  Loads assets.
        5.  Configures and adds the start button Actor.
        6.  Configures and adds the label next to the start button.
        7.  Configures and adds the labels with the created by text.
        8.  Configures and adds the labels with the music by text.
        9.  Loads atlas information.
        */
        ...
        if (gameHD.config.getStretchToScreen())
            ...
            // Assign the Texture to the background Actor.
            background.setTexture( new Texture(Gdx.files.internal(gameHD.config.getPrescaleFolder_Backgrounds() + 
              "nightsky.png")) );
            }
        ...
        // 5.  Configure and add the start button Actor.
        ...
        startButton.setTextureRegion( gameHD.assetMgr.getTextureRegion(startButtonKey) );
        ...
        // 6.  Configure and add the label next to the start button.
        ...
        // 7.  Configure and add the labels with the created by text.
        ...
        // 8.  Configure and add the label with the music by text.
        ...
        gameHD.atlas = json.readAtlas(jsonFullPath);
    ...
    private void loadAssets()
    {
        ...
        if (gameHD.config.getStretchToScreen())
            ...
            for (HeroineEnum.ImgInterfaceEnum imgEnum : HeroineEnum.ImgInterfaceEnum.values())
                ...
                // Specify atlas path.
                atlasPath = gameHD.config.getPrescaleFolder_Interface() + imgEnum.getValue_AtlasFile();
